...
import com.zhaosoft.example.exam874.Solution;
import com.zhaosoft.example.exam874.Solution874_2;
import org.junit.Assert;
import org.junit.Test;

public class SolutionTest874_2 {
    @Test
    public void test0() {
        int[] commands = new int[]{4, -1, 4, -2, 4};
        int[][] obstacles = new int[][]{{2, 4}};
        Solution874_2 solution = new Solution874_2();
    ...
    public void test2(){
        ...
        Solution874_2 solution = new Solution874_2();
        // Assert.assertEquals();
        int sum=solution.robotSim(commands, obstacles);
        System.out.println(sum);
        Assert.assertEquals(5140, sum);
    }
}
